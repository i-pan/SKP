...
cfg.fold = 0
cfg.dataset = "mura.single_image"
cfg.data_dir = "/mnt/stor/datasets/mura/"
cfg.annotations_file = "/mnt/stor/datasets/mura/MURA-v1.1/train_kfold_cv.csv"
cfg.inputs = "filepath"
exam_types = ["wrist", "shoulder", "hand", "finger", "elbow", "forearm", "humerus"]
cfg.targets = [f"abnormal_{t}" for t in exam_types] + ["label"]
...
cfg.metrics = ["custom_cls.MURA_AUROC_V3"]
