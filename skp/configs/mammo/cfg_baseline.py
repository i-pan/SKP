...
cfg.data_dir = "/mnt/stor/datasets/kaggle/rsna-breast-cancer-detection/train_cropped_png/"
cfg.annotations_file = "/mnt/stor/datasets/kaggle/rsna-breast-cancer-detection/train_kfold_cv.csv"
cfg.inputs = "filename"
cfg.targets = ["cancer"]
