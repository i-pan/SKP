...
cfg.model = "MIL.net2d_attn_v02"
cfg.backbone = "tf_efficientnetv2_s"
cfg.pretrained = False
cfg.load_pretrained_backbone = os.path.join(
    cfg.save_dir, "mammo.cfg_ddsm_pretrained_aux_losses_v02/507493bc/fold0/checkpoints/last.ckpt"
)
