...
cfg.fold = 0
cfg.dataset = "mammo.seg_cls_patch"
...
image_height = cfg.image_height * 4
image_width = cfg.image_width * 2

cfg.pad_to_aspect_ratio = image_height / image_width

resize_transforms = [A.Resize(image_height, image_width, p=1)]
