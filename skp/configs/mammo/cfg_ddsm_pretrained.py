...
cfg.pretrained = True
cfg.load_pretrained_backbone = os.path.join(cfg.save_dir, "mammo.cfg_ddsm_seg_cls", "38c38c95/fold0/checkpoints/last.ckpt")
...
cfg.metrics = ["custom_cls.GroupedAUROC"]
cfg.val_metric = "auc_mean_agg"
cfg.val_track = "max"
