...
cfg.load_pretrained_backbone = os.path.join(
    cfg.save_dir, "mammo.cfg_ddsm_seg_cls_v02", "445e5ce2/fold0/checkpoints/last.ckpt"
)
...
cfg.annotations_file = (
    "/mnt/stor/datasets/kaggle/rsna-breast-cancer-detection/train_kfold_cv_v01.csv"
)
cfg.inputs = "filename"
cfg.targets = [
    "cancer",
