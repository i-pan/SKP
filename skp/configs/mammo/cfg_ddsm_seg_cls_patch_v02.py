...
cfg.fold = 0
cfg.dataset = "mammo.seg_cls_patches_from_disk"
cfg.data_dir = "/mnt/stor/datasets/CBIS-DDSM/patches_1-8"
cfg.seg_data_dir = "/mnt/stor/datasets/CBIS-DDSM/patches_masks_1-8"
cfg.annotations_file = "/mnt/stor/datasets/CBIS-DDSM/train_kfold_cv_patches.csv"
cfg.inputs = "filename"
cfg.masks = "filename"
...
# segmentation model uses cfg.image_height and cfg.image_width
# to resize output
