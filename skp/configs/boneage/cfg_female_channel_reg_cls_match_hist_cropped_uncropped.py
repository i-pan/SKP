...
cfg.data_dir = "/mnt/stor/datasets/bone-age/"
cfg.annotations_file = "/mnt/stor/datasets/bone-age/train_plus_valid_cropped_and_uncropped_kfold.csv"
...
cfg.match_hist_as_train_aug = True
cfg.num_workers = 16
cfg.pin_memory = True
