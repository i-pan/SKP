...
cfg.pretrained = True
cfg.load_pretrained_model= cfg.save_dir + "ich.cfg_slice_segment_2dc_pos_only/95f0f85e/fold0/checkpoints/last.ckpt"
cfg.load_pretrained_segmentation_heads = True
...
cfg.metrics = ["segmentation.MulticlassDiceScore"]
cfg.metric_invert_background = True
