...
image_height = [256, 512, 1024]
image_width = [256, 512, 1024]
base_lr = 3e-4
cfg.progressive_resizing = {
    "atrous_rates": [(2, 4, 6, 8), (3, 6, 9, 12), (6, 12, 18, 24)],
    "batch_size": [64, 16, 4],
    "num_epochs": [5, 5, 5],
...
cfg.progressive_resizing["train_transforms"] = [
    A.Compose([_resize] + [A.HorizontalFlip(p=0.5)], p=1)
