...
class Net(nn.Module):
    def __init__(self, cfg: Config):
        ...
        if self.cfg.load_pretrained_segmenter:
            print(f"Loading pretrained segmenter from {self.cfg.load_pretrained_segmenter} ...")
            weights = torch.load(self.cfg.load_pretrained_segmenter, map_location="cpu", weights_only=True)["state_dict"]
